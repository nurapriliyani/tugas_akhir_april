<div style="display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap;">
    ...
    <div style="background:#fbeaea;border:1px solid #f0c4c4;border-radius:10px;padding:14px 16px;font-size:12px;color:#8a4040;line-height:1.7;max-width:220px;">
        <strong style="display:block;margin-bottom:4px;">⚠️ Perhatian</strong>
...
<div class="modal-overlay" id="deleteModal" onclick="if(event.target===this)this.classList.remove('open')">
    <div class="modal-box">
        <div style="width:44px;height:44px;background:#fbeaea;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:20px;margin-bottom:14px;">⚠️</div>
